...
def plot_pie_chart(categories, data):#draw the picture
    ...
    plt.legend(handles, labels, loc='lower right', bbox_to_anchor=(1.1, -0.05),fontsize='small')
    
    plt.title('Sentiment Analysis of Students Towards the STATS399 Course',fontsize= 15,pad=20)
    plt.show()
